...
The more detailed, the better the fix!`),
  ...
  private setupPrompts(): void {
    ...
    this.server.prompt(
      ...
      'Guide for using the Cheestard Terminal Interactive system',
      {},
          ...
          messages: [
            {
              ...
              content: {
                type: 'text',
                text: `# Cheestard Terminal Interactive System Usage Guide

This MCP server provides Cheestard Terminal Interactive session management. Here's how to use it:
